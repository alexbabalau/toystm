...
import 'my_toy_view.dart';

class MyToys extends StatefulWidget {
  //ToyFirestoreModel toy = ToyFirestoreModel(dateAdded: DateTime.now());

  @override
  State<MyToys> createState() => _MyToysState();
}

class _MyToysState extends State<MyToys> {
  ...
  Future<List<ToyFirestoreModel>> _fetchMyToys() async{
    return await this._firestoreService.getUserToys(userId);
  }

  @override
  void initState(){
    _fetchFuture = this._fetchMyToys();
  }
